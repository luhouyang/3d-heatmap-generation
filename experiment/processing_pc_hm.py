...
if __name__ == '__main__':
    # File paths
    input_file = r"C:\Users\User\Desktop\Python\deep_learning\3d-heatmap-generation\experiment\pointcloud.csv"
    model_file = r"C:\Users\User\Desktop\Python\deep_learning\3d-heatmap-generation\experiment\model.obj"
    output_point_cloud = r"C:\Users\User\Desktop\Python\deep_learning\3d-heatmap-generation\experiment\density_colored_pointcloud.ply"
    output_mesh = r"C:\Users\User\Desktop\Python\deep_learning\3d-heatmap-generation\experiment\density_heatmap_mesh.ply"

    # Check if the input file exists
    if not os.path.exists(input_file):
        print(
            f"Error: Input file '{input_file}' not found. Please make sure the path is correct."
        )
        exit()
